    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col">
          ...
          <select
            {...register('type')}
            className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-3 text-sm text-slate-900 
            dark:text-slate-100 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div className="flex flex-col">
          ...
          <input
            ...
            className={`w-full bg-slate-50 dark:bg-slate-950 border rounded-xl p-3 text-sm text-slate-900 dark:text-slate-100 
      ...
      <div className="flex items-center justify-end gap-3 pt-5 mt-6 border-t border-slate-100 dark:border-slate-800/60">
        <button
          ...
          className="px-5 py-2.5 rounded-xl text-sm font-semibold text-slate-600 dark:text-slate-400 hover:bg-slate-50 
          dark:hover:bg-slate-800/40 hover:text-slate-900 dark:hover:text-white transition-colors"
        >
          Cancelar
        </button>
        ...
        <button
          ...
          className="px-6 py-2.5 rounded-xl bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500 
          text-slate-950 dark:text-white font-bold text-sm shadow-lg shadow-blue-500/10 transition-all active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none"
        >
