  ...
  return (
    <MainLayout>
      <div className="space-y-6 max-w-7xl mx-auto">
        ...
        {/* FIX: Container do botão que se torna STICKY no mobile e volta ao normal (static) no PC */}
        {/* O top-16 joga ele logo abaixo do Header. O background opaco esconde as taxas rolando por trás */}
